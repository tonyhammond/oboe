...
class Entity
  ...
  def get_id() get_descriptors_of_type(Descriptor::ID) end
  def get_metadata() get_descriptors_of_type(Descriptor::METADATA) end
  def get_metadata_ptr() get_descriptors_of_type(Descriptor::METADATA_PTR) end
  def get_private_data() get_descriptors_of_type(Descriptor::PRIVATE_DATA) end
