...
module Oboe
  ...
  @@qs0 =<<-EOT
    ...
    & ref_reffmt = jarticle
    & ref_ptr = uri:http://www2.elsevier.co.uk/~tony/ref.ptr
    & rfr_id = ori:dbid:dlib.org:D-Lib%20Magazine
  ...
  @@qs1 =<<-EOT
    ...
    & volume = 5
    & issue = 7%2F8
    & title = Reference%20Linking%20for%20Journal%20Articles
    & rfr_id = ori:dbid:dlib.org:D-Lib%20Magazine
    & rfe_id = ori:doi:10.1045/march2001-vandesompel
    & adm_ver = Z39.00-00
  EOT
  ...
  # Example 4
  @@qs4 =<<-EOT
    & ref_id  = ori:doi%3A10.1126%2Fscience.275.5304.1320
    & ref_id  = ori:pmid%3A9036860
    & rfr_id  = ori:dbid%3Acrossref.org%3Aidealibrary.com
    & rfe_id  = ori:doi%3A10.1006%2Fmthe.2000.0239
    & rfe_id  = ori:issn%3A1525-0016
    & adm_ver = Z39.00-00
  ...
  def initialize
    ...
    @querystring = eval eval "'@@qs' + rand(5).to_s"
    @querystring.gsub!(/\s+/, "")
